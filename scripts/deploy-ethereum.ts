...
async function main() {
    ...
    await createTrove(acc2, _borrowerOperations.address, _rusdToken, _troveManager, _hintHelpers, '30000000000000000000', '6000000000000000000000');
    await createTrove(acc3, _borrowerOperations.address, _rusdToken, _troveManager, _hintHelpers, '16000000000000000000', '12000000000000000000000');
    await createTrove(acc0, _borrowerOperations.address, _rusdToken, _troveManager, _hintHelpers, '10000000000000000000', '15000000000000000000000');
    await createTrove(acc1, _borrowerOperations.address, _rusdToken, _troveManager, _hintHelpers, '10000000000000000000', '15000000000000000000000');
